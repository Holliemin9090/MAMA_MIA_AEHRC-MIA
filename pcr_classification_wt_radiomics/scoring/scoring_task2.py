...
def calculated_scoring_task2(binary_prediction, pred_prob, clinical_df, output_plots_dir):
    ...
    fairness_varibles_df['pcr_pred'] = binary_prediction
    fairness_varibles_df['pcr_pred'] = fairness_varibles_df['pcr_pred'].astype(int)
    fairness_varibles_df['pcr_prob'] = pred_prob
    ...
    ranking_score = (1 - alpha) * performance_score + alpha * (1 - fairness_score)#!!!!!!! This is the final ranking score used for the challenge
    ...
    return balanced_accuracy, 1 - fairness_score, ranking_score
