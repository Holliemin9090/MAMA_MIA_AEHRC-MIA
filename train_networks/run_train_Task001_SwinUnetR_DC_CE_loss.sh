...
#SBATCH --gres=gpu:1
#SBATCH --array=0-4
#SBATCH --output=slurm_files/train_swinunetr_%A_%a.log
...
mednextv1_train 3d_fullres nnUNetTrainerV2_SwinUNETR_128x128x128 Task001_breastDCE $INDEX 300 DC_and_CE_loss -p nnUNetPlansv2.1_trgSp_1x1x1 --npz
